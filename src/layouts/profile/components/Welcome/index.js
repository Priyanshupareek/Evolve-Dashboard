    ...
    >
      <VuiBox display="flex" flexDirection="column" sx={{ height: "100%" }}>
        <VuiBox display="flex" flexDirection="column" mb="auto">
          ...
          <VuiTypography color="white" variant="button" fontWeight="regular" mb="50px">
            Nice to see you buddy!
          </VuiTypography>
          <VuiTypography color="white" variant="h4" fontWeight="regular" >
          We've been keeping tabs on your journey, and here's how you've been interacting with the ROKO ecosystem
          </VuiTypography>
        </VuiBox>
